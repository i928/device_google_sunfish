...
# Device Health Services background exemptions
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/allowlist_com.google.android.apps.turbo.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/allowlist_com.google.android.apps.turbo.xml
